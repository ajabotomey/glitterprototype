...
public class UnityBuild
{
    ...
    private static readonly string AndroidSdkDirectory = ""; // Change to directory on laptop
    ...
    private static readonly Dictionary<BuildTarget, PlatformSpecificBuildOptions> PlatformBuildOptions = new Dictionary<BuildTarget, PlatformSpecificBuildOptions>()
{
     ...
     */
    private static readonly string DriveTempDirectory = "C:/Users/kille/Documents"; // Modify for laptop
    private static readonly string DriveTempFolderName = "JenkinsTemp"; 

    private static readonly string DriveDirectory = "C:/Users/Kille/Google Drive"; // Modify for laptop
